<script setup></script>
<template>
  <div class="w-full h-[100vh] flex justify-center items-center bg-gray-700">
    <form class="border-solid border-[2px] p-20 rounded-xl border-gray-600 max-w-sm mx-auto">
      <div class="mb-5">
