...
<template>
  <div class="flex w-full bg-gray-700">
    <aside
      id="logo-sidebar"
      class="w-[20%] top-0 md:visible hidden md:flex left-0 z-40 w-64 h-screen pt-5 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
      aria-label="Sidebar"
    >
      <div class="h-full flec flex-row px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ms-3 whitespace-nowrap">Provedores</span>
              <span
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ms-3 whitespace-nowrap">Bodega</span>
            </a>
          </li>
          <li>
            <a
    ...
    <div
      class="relative flex-r m-10 items-center w-[100%] bg-gray-700 flex flex-row h-fit p-5 boder-solid border-[2px] border-gray-600 overflow-x-auto shadow-md sm:rounded-lg"
    >
      <table
